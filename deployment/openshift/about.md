...
To change the Docker configuration permanently, edit (as the `root` user) the file `/etc/docker/daemon.json` and add `172.30.0.0/16` to the key `insecure-registries`. For example:
