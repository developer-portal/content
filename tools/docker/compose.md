...
[Docker Compose](https://docs.docker.com/compose/) is a tool to orchestrate one or more containers using a simple YAML file which describes your whole setup.
